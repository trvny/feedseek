...
Four native Atom feeds, merged into one:

    - Lichess updates          https://lichess.org/feed.atom
    - Official Lichess blog     https://lichess.org/@/Lichess/blog.atom
...
SOURCES = [
    ...
    ("Official Lichess Blog", "https://lichess.org/@/Lichess/blog.atom", 60),
...
def main(full=False):
    return run(
        feed_name=FEED_NAME,
        title="Lichess",
        subtitle="Official Lichess feeds plus the Polish and English community blogs.",
