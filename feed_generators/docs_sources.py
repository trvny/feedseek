...
GROUPS = [
    ...
    ("💻 Tech / vendorzy oprogramowania", ["microsoft", "microsoft_updates", "redhat", "cloudflare", "docker", "gitlab", "github", "mozilla", "google", "apple", "sony", "lenovo", "canva", "youtube", "meta_newsroom", "saas", "hackerone", "creativecommons"]),
