...
For Feedseek usage, source, feed, and ChatGPT plugin questions, start with the public project repository:
...
https://github.com/trvny

Please do not send passwords, API keys, authentication tokens, private feed credentials, or other sensitive information in support requests. Feedseek's public ChatGPT app does not require those secrets.
