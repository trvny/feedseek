...
class PlayerWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE = "com.feedy.player.widget.action.TOGGLE"
        const val ACTION_NEXT = "com.feedy.player.widget.action.NEXT"
        const val ACTION_PREV = "com.feedy.player.widget.action.PREV"
        ...
        private fun widgetActionIntent(context: Context, appWidgetId: Int, action: String): PendingIntent {
            val intent = Intent(context, PlayerWidgetProvider::class.java).apply {
                this.action = action
                data = Uri.parse("feedy-player://$action/$appWidgetId")
            }
        ...
        private fun openAppIntent(context: Context, appWidgetId: Int): PendingIntent {
            val intent = Intent(context, com.feedy.ui.PlayerActivity::class.java)
