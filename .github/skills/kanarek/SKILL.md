...
Never claim it compiles — point build signal at CI (`android-ci.yml`: `assemblePlayDebug assembleFossDebug testPlayDebugUnitTest lintPlayDebug`; `worker-ci.yml`: `tsc` + Vitest) and report commit SHA + run conclusion. Keep `kanarek/README.md` and `kanarek/docs/HISTORY.md` current with any feature change.
...
| News widget or player widget blank/stale/crashing, player playback, Compose/Media3 work, AGP 9.3 / Gradle 9.6.1, lint baseline, OPML/M3U | `references/android.md` |
